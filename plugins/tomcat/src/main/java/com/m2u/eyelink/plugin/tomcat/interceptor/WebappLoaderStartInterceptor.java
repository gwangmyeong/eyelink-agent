...
public class WebappLoaderStartInterceptor implements AroundInterceptor {
	...
	public void after(Object target, Object[] args, Object result, Throwable throwable) {
		...
		if (target instanceof WebappLoader) {
			...
			logger.warn("Webapp loader is not an instance of org.apache.catalina.loader.WebappLoader. Found [{}]",
	...
	// FIXME Use reflection until we provide separate packages for instrumented
	// libraries.
	// Tomcat 8's WebappLoader does not have getContainer() method.
	// Providing an optional package that calls WebappLoader.getContext() method
	// could be an option.
	private Container extractContext(WebappLoader webappLoader)
	...
	private List<String> extractLibJars(WebappLoader webappLoader) {
		...
		if (classLoader instanceof URLClassLoader) {
			...
			logger.warn("Webapp class loader is not an instance of URLClassLoader. Found [{}]",

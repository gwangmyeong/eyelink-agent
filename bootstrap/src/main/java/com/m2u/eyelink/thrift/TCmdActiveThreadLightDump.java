            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.threadNameList = new ArrayList<String>(_list56.size);
                String _elem57;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.localTraceIdList = new ArrayList<Long>(_list59.size);
                long _elem60;
      ...
      if (struct.threadNameList != null) {
        if (struct.isSetThreadNameList()) {
          oprot.writeFieldBegin(THREAD_NAME_LIST_FIELD_DESC);
          {
            ...
            for (String _iter62 : struct.threadNameList)
            {
      ...
      if (struct.isSetThreadNameList()) {
        {
          ...
          for (String _iter64 : struct.threadNameList)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.threadNameList = new ArrayList<String>(_list66.size);
          String _elem67;
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.localTraceIdList = new ArrayList<Long>(_list69.size);
          long _elem70;

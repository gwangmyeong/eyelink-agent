...
public class TServerMetaData implements
		org.apache.thrift.TBase<TServerMetaData, TServerMetaData._Fields>,
		java.io.Serializable, Cloneable, Comparable<TServerMetaData> {
	private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
			"TServerMetaData");

	private static final org.apache.thrift.protocol.TField SERVER_INFO_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"serverInfo", org.apache.thrift.protocol.TType.STRING, (short) 1);
	private static final org.apache.thrift.protocol.TField VM_ARGS_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"vmArgs", org.apache.thrift.protocol.TType.LIST, (short) 2);
	private static final org.apache.thrift.protocol.TField SERVICE_INFOS_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"serviceInfos", org.apache.thrift.protocol.TType.LIST, (short) 10);

	private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
	static {
		schemes.put(StandardScheme.class,
				new TServerMetaDataStandardSchemeFactory());
	...
	public enum _Fields implements org.apache.thrift.TFieldIdEnum {
		SERVER_INFO((short) 1, "serverInfo"), VM_ARGS((short) 2, "vmArgs"), SERVICE_INFOS(
				(short) 10, "serviceInfos");
	...
	private static final _Fields optionals[] = { _Fields.SERVER_INFO,
			_Fields.VM_ARGS, _Fields.SERVICE_INFOS };
	public static final Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
	static {
		Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(
				_Fields.class);
		tmpMap.put(_Fields.SERVER_INFO,
				new org.apache.thrift.meta_data.FieldMetaData("serverInfo",
		...
		org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
				TServerMetaData.class, metaDataMap);
	}
	...
	/**
	 * Returns true if field serverInfo is set (has been assigned a value) and
	 * false otherwise
	 */
	...
	/**
	 * Returns true if field vmArgs is set (has been assigned a value) and false
	 * otherwise
	 */
	...
	public java.util.Iterator<TServiceInfo> getServiceInfosIterator() {
		return (this.serviceInfos == null) ? null : this.serviceInfos
				.iterator();
	}
	...
	/**
	 * Returns true if field serviceInfos is set (has been assigned a value) and
	 * false otherwise
	 */
	...
	public int compareTo(TServerMetaData other) {
		...
		lastComparison = Boolean.valueOf(isSetServerInfo()).compareTo(
				other.isSetServerInfo());
		if (lastComparison != 0) {
		...
		lastComparison = Boolean.valueOf(isSetVmArgs()).compareTo(
				other.isSetVmArgs());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetVmArgs()) {
			lastComparison = org.apache.thrift.TBaseHelper.compareTo(
					this.vmArgs, other.vmArgs);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetServiceInfos()).compareTo(
				other.isSetServiceInfos());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetServiceInfos()) {
			lastComparison = org.apache.thrift.TBaseHelper.compareTo(
					this.serviceInfos, other.serviceInfos);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
	...
	private static class TServerMetaDataStandardSchemeFactory implements
			SchemeFactory {
	...
	private static class TServerMetaDataStandardScheme extends
			StandardScheme<TServerMetaData> {

		public void read(org.apache.thrift.protocol.TProtocol iprot,
				TServerMetaData struct) throws org.apache.thrift.TException {
			...
			while (true) {
				...
				case 10: // SERVICE_INFOS
					if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
						{
							org.apache.thrift.protocol.TList _list11 = iprot
									.readListBegin();
							struct.serviceInfos = new ArrayList<TServiceInfo>(
									_list11.size);
	...
	private static class TServerMetaDataTupleSchemeFactory implements
			SchemeFactory {
	...
	private static class TServerMetaDataTupleScheme extends
			TupleScheme<TServerMetaData> {

...
public class ASMClassNodeAdapter {
    ...
    public ASMMethodNodeAdapter addDelegatorMethod(final ASMMethodNodeAdapter superMethodNode) {
		...
		final ASMMethodNodeAdapter methodNode = new ASMMethodNodeAdapter(
				getInternalName(), new MethodNode(superMethodNode.getAccess(),
						superMethodNode.getName(), superMethodNode.getDesc(),

...
import static com.m2u.eyelink.agent.profiler.monitor.codahale.MetricMonitorValues.EXCLUDED_DOUBLE;
import static com.m2u.eyelink.agent.profiler.monitor.codahale.MetricMonitorValues.JVM_GC_SERIAL_NEWGEN_COUNT;
import static com.m2u.eyelink.agent.profiler.monitor.codahale.MetricMonitorValues.JVM_GC_SERIAL_NEWGEN_TIME;
import static com.m2u.eyelink.agent.profiler.monitor.codahale.MetricMonitorValues.JVM_MEMORY_POOLS_SERIAL_CODE_CACHE_USAGE;
import static com.m2u.eyelink.agent.profiler.monitor.codahale.MetricMonitorValues.JVM_MEMORY_POOLS_SERIAL_METASPACE_USAGE;
import static com.m2u.eyelink.agent.profiler.monitor.codahale.MetricMonitorValues.JVM_MEMORY_POOLS_SERIAL_NEWGEN_USAGE;
import static com.m2u.eyelink.agent.profiler.monitor.codahale.MetricMonitorValues.JVM_MEMORY_POOLS_SERIAL_OLDGEN_USAGE;
import static com.m2u.eyelink.agent.profiler.monitor.codahale.MetricMonitorValues.JVM_MEMORY_POOLS_SERIAL_PERMGEN_USAGE;
import static com.m2u.eyelink.agent.profiler.monitor.codahale.MetricMonitorValues.JVM_MEMORY_POOLS_SERIAL_SURVIVOR_USAGE;
import static com.m2u.eyelink.agent.profiler.monitor.codahale.MetricMonitorValues.getDoubleGauge;
import static com.m2u.eyelink.agent.profiler.monitor.codahale.MetricMonitorValues.getLongGauge;

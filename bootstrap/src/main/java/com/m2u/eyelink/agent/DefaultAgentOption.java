...
public class DefaultAgentOption implements AgentOption {
	...
	public DefaultAgentOption(final Instrumentation instrumentation,
			String agentId, String applicationName,
			final ProfilerConfig profilerConfig, final URL[] pluginJars,
		...
		if (annotationKeyRegistryService == null) {
			throw new NullPointerException(
					"annotationKeyRegistryService must not be null");
		}
		if (serviceTypeRegistryService == null) {
			throw new NullPointerException(
					"serviceTypeRegistryService must not be null");
		}
	...
	public String toString() {
		...
		sb.append(", serviceTypeRegistryService=").append(
				serviceTypeRegistryService);
		sb.append(", annotationKeyRegistryService=").append(

...
public class AntPathMatcher implements PathMatcher {
	private final com.m2u.eyelink.util.spring.AntPathMatcher springAntMatcher;
	private final String pattern;

	public AntPathMatcher(String pattern) {
		this(
				pattern,
				com.m2u.eyelink.util.spring.AntPathMatcher.DEFAULT_PATH_SEPARATOR);
	}
	...
	public AntPathMatcher(String pattern, String pathSeparator) {
		...
		this.springAntMatcher = new com.m2u.eyelink.util.spring.AntPathMatcher(
				pathSeparator);

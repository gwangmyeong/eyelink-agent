...
import com.m2u.eyelink.collector.cluster.zookeeper.exception.AuthException;
import com.m2u.eyelink.collector.cluster.zookeeper.exception.BadOperationException;
...
import com.m2u.eyelink.collector.cluster.zookeeper.exception.NoNodeException;
import com.m2u.eyelink.collector.cluster.zookeeper.exception.UnknownException;
...
public class DefaultZookeeperClient implements ZookeeperClient {
     ...
     *
     * @throws ELAgentZookeeperException
     * @throws InterruptedException
     */
    @Override
    public void createPath(String path) throws ELAgentZookeeperException, InterruptedException {
        createPath(path, false);
    }

    @Override
    public void createPath(String path, boolean createEndNode) throws ELAgentZookeeperException, InterruptedException {
        checkState();
    ...
    @Override
    public String createNode(String zNodePath, byte[] data) throws ELAgentZookeeperException, InterruptedException {
        checkState();
    ...
    @Override
    public byte[] getData(String path) throws ELAgentZookeeperException, InterruptedException {
        checkState();
    ...
    @Override
    public void setData(String path, byte[] data) throws ELAgentZookeeperException, InterruptedException {
        checkState();
    ...
    @Override
    public void delete(String path) throws ELAgentZookeeperException, InterruptedException {
        checkState();
    ...
    @Override
    public boolean exists(String path) throws ELAgentZookeeperException, InterruptedException {
        checkState();
    ...
    private void checkState() throws ELAgentZookeeperException {
        if (!isConnected()) {
    ...
    @Override
    public List<String> getChildrenNode(String path, boolean watch) throws ELAgentZookeeperException, InterruptedException {
        checkState();
    ...
    private void handleException(KeeperException keeperException) throws ELAgentZookeeperException {

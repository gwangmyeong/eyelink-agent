...
@Repository
public class ElasticSearchHostApplicationMapDao implements HostApplicationMapDao {
    ...
    byte[] createRowKey0(String parentApplicationName, short parentServiceType, long statisticsRowSlot, String parentAgentId) {
        ...
        final int SIZE = ElasticSearchTables.APPLICATION_NAME_MAX_LEN + 2 + 8;
        final Buffer rowKeyBuffer = new AutomaticBuffer(SIZE);
        rowKeyBuffer.putPadString(parentApplicationName, ElasticSearchTables.APPLICATION_NAME_MAX_LEN);
...
//        rowKeyBuffer.putPadString(parentAgentId, ElasticSearchTables.AGENT_NAME_MAX_LEN);

...
public class ParallelResultScanner implements ResultScanner {
    ...
    public ParallelResultScanner(TableName tableName, ElasticSearchAccessor hbaseAccessor, ExecutorService executor, Scan originalScan, AbstractRowKeyDistributor keyDistributor, int numParallelThreads) throws IOException {

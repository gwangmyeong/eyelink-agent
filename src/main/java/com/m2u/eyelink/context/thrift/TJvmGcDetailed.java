...
public class TJvmGcDetailed implements org.apache.thrift.TBase<TJvmGcDetailed, TJvmGcDetailed._Fields>, java.io.Serializable, Cloneable, Comparable<TJvmGcDetailed> {
  ...
  static {
    schemes.put(StandardScheme.class, new TJvmGcDetailedStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TJvmGcDetailedTupleSchemeFactory());
  }
  ...
  private static class TJvmGcDetailedStandardScheme extends StandardScheme<TJvmGcDetailed> {
  ...
  private static class TJvmGcDetailedTupleScheme extends TupleScheme<TJvmGcDetailed> {

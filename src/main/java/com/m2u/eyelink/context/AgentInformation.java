...
public class AgentInformation {
	...
	public AgentInformation(String agentId, String applicationName,
			long startTime, int pid, String machineName, String hostIp,
			ServiceType serverType, String jvmVersion, String agentVersion) {
		if (agentId == null) {
	...
	public Map<String, Object> toMap() {
		...
		map.put(HandshakePropertyType.APPLICATION_NAME.getName(),
		...
		map.put(HandshakePropertyType.SERVICE_TYPE.getName(),

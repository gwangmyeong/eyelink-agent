...
public class CmsDetailedMetricsCollector extends CmsCollector {
    ...
    public CmsDetailedMetricsCollector(MetricMonitorRegistry registry) {
    ...
    public String toString() {
        return "HotSpot's Concurrent-Mark-Sweep collector with detailed metrics";
    }
